...
//                 spread: 200,
//                 origin: { y: 0.6 },
//                 colors: ['#10B981', '#34D399', '#6EE7B7', '#8B5CF6', '#7C3AED', '#6366F1', '#4F46E5'],
//                 zIndex: 1000,
//             });
//         }
//     }, [previewImage, downloadReady]);
...
//                 const backgroundOption = formData.get('background_option') || 'transparent';
//                 const backgroundColor = formData.get('background_color') || '#ffffff';
//                 const bgFile = formData.get('background_file'); // Define bgFile
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.8 }}
//             className="flex flex-col items-center min-h-screen py-16 px-4 sm:px-6 lg:px-8"
//         >
//             <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center text-white [text-shadow:2px_2px_4px_rgba(0,0,0,0.5)]">
//                 Convert or Remove Background
//             </h1>
//             <div className="w-full max-w-lg bg-gradient-to-br from-purple-700/50 to-indigo-900/50 rounded-xl p-6 sm:p-8 mb-8 shadow-2xl">
//                 <form onSubmit={handleSubmit} encType="multipart/form-data" className="flex flex-col gap-y-6">
//                     <div className="flex flex-col items-center">
//                         <label
//                             htmlFor="file-input"
//                             className="inline-block bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold text-lg cursor-pointer hover:-translate-y-1 hover:shadow-xl transition-all duration-300 py-3 px-10 rounded-lg shadow-md"
//                         >
//                             Choose Foreground Image
//                         </label>
//                         <input
...
//                         </label>
//                     </div>
//                     <div className="flex flex-col items-center text-gray-200 gap-y-4">
...
//                                 checked={backgroundOption === 'color'}
//                                 onChange={handleBackgroundOptionChange}
//                                 className="mr-2 h-4 w-4 text-green-600 border-gray-400 focus:ring-green-500"
//                             />
//                             Solid Color
//                         </label>
//                         {backgroundOption === 'color' && (
...
//                     <button
//                         type="submit"
//                         className="w-full bg-gradient-to-r from-green-500 to-blue-500 text-white font-semibold py-3 px-4 rounded-lg shadow-md hover:bg-gray-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
//                         disabled={isPending}
//                     >
//                         {isPending ? 'Processing...' : 'Process Image'}
//                     </button>
...
//                     animate={{ opacity: 1, scale: 1 }}
//                     transition={{ duration: 0.5 }}
//                     className="w-full max-w-md bg-gradient-to-r from-purple-600 via-indigo-600 to-black rounded-xl overflow-hidden shadow-xl mb-8"
//                 >
//                     <Image
//                         src={previewImage}
//                         alt="Processed Image"
...
//                     href={previewImage}
//                     download="converted_image.png"
//                     className="w-full sm:max-w-xs bg-gradient-to-r from-green-500 to-blue-500 text-white font-semibold py-2 px-6 rounded-xl shadow-md hover:bg-gray-600 transition-all duration-300 text-center mb-4"
//                 >
//                     Download Image
//                 </a>
//             )}
//             <Link
//                 href="/"
//                 className="w-full sm:max-w-xs bg-gradient-to-r from-green-500 to-blue-500 text-white font-semibold py-2 px-4 rounded-xl shadow-md hover:bg-gray-600 transition-all duration-300 text-center"
//             >
//                 Back to Home
//             </Link>
//         </motion.div>
